...
class PlutoProvider(BaseProvider):
    ...
    def _get_session_token(self) -> str:
        ...
        try:
            ...
            response = requests.get(
                url, headers=self.headers, params=params, timeout=self.get_timeout()
            )
            data = response.json()
    ...
    def get_channels(self) -> List[Dict[str, Any]]:
        try:
            ...
            for channel in channel_data:
                ...
                stream_url = (
                    f"https://cfd-v4-service-channel-stitcher-use1-1.prd.pluto.tv"
                    f"/v2/stitch/hls/channel/{channel_id}/master.m3u8"
    ...
    def generate_m3u(self, channels):
        ...
        m3u = (
            f'#EXTM3U url-tvg="https://github.com/matthuisman/i.mjh.nz/raw/master/'
            f'PlutoTV/{self.region}.xml.gz"\n'
        )
...
def merge_master_playlist():
    ...
    files = [
        f for f in glob.glob("pluto_*.m3u")
    ...
    master_content = (
        '#EXTM3U url-tvg="https://github.com/matthuisman/i.mjh.nz/raw/master/'
        'PlutoTV/all.xml.gz"\n'
    )
